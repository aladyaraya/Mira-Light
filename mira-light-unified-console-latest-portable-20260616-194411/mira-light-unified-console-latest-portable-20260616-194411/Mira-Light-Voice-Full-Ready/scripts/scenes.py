...
SCENE_META: Dict[str, Dict[str, Any]] = {
    ...
    "look_left": {
        ...
        "requirements": ["基础姿态已校准"],
        "requirementIds": [],
        "fallbackHint": "curious_half_left -> curious_full_left -> tilt_left",
        "operatorCue": "语音方向指令基础动作：Mira 左转 / 看左边。",
    },
    "look_right": {
        "emotionTags": ["方向", "听懂指令"],
        "readiness": "ready",
        ...
        "requirements": ["基础姿态已校准"],
        "requirementIds": [],
        "fallbackHint": "tilt_right -> modest right look -> neutral",
        "operatorCue": "语音方向指令基础动作：Mira 右转 / 看右边。",
    },
    "touch_affection": {
        "emotionTags": ["亲近", "撒娇"],
        "readiness": "tuning",
    ...
    # --- New emotional scenes (11-26) ---
    "happy_dance": {
        "emotionTags": ["开心", "兴奋", "跳舞"],
        "readiness": "ready",
        "durationMs": 4000,
        "accent": "celebrate",
        "priority": "P0",
        "requirements": [],
        "requirementIds": [],
        "fallbackHint": "四舵机弹跳摇摆，灯光暖色",
        "operatorCue": "当 Mira 需要表达开心、兴奋或跳舞时执行。",
    },
    "sad_comfort": {
        "emotionTags": ["难过", "安慰", "悲伤"],
        "readiness": "ready",
        "durationMs": 4500,
        "accent": "comfort",
        "priority": "P0",
        "requirements": [],
        "requirementIds": [],
        "fallbackHint": "四舵机缓慢摇摆，灯光偏暗暖",
        "operatorCue": "当 Mira 需要表达难过或安慰时执行。",
    },
    "curious_peek": {
        "emotionTags": ["好奇", "探头", "窥探"],
        "readiness": "ready",
        "durationMs": 3500,
        "accent": "curious",
        "priority": "P0",
        "requirements": [],
        "requirementIds": [],
        "fallbackHint": "四舵机快速探头后缩，灯光好奇色",
        "operatorCue": "当 Mira 对某物好奇、探头查看时执行。",
    },
    "shy_blush": {
        "emotionTags": ["害羞", "脸红", "不好意思"],
        "readiness": "ready",
        "durationMs": 4000,
        "accent": "warm",
        "priority": "P1",
        "requirements": [],
        "requirementIds": [],
        "fallbackHint": "四舵机转开再偷看，灯光粉色",
        "operatorCue": "当 Mira 被夸奖或感到害羞时执行。",
    },
    "stretch_yawn": {
        "emotionTags": ["伸懒腰", "打哈欠", "放松"],
        "readiness": "ready",
        "durationMs": 5000,
        "accent": "dream",
        "priority": "P1",
        "requirements": [],
        "requirementIds": [],
        "fallbackHint": "四舵机大幅伸展，灯光渐亮",
        "operatorCue": "当 Mira 需要伸展放松或打哈欠时执行。",
    },
    "alert_startle": {
        "emotionTags": ["受惊", "吓一跳", "警觉"],
        "readiness": "ready",
        "durationMs": 3000,
        "accent": "alert",
        "priority": "P0",
        "requirements": [],
        "requirementIds": [],
        "fallbackHint": "四舵机快速弹开再缓慢恢复",
        "operatorCue": "当 Mira 被突然的声音或动作吓到时执行。",
    },
    "greeting_wave": {
        "emotionTags": ["打招呼", "挥手", "欢迎"],
        "readiness": "ready",
        "durationMs": 3500,
        "accent": "warm",
        "priority": "P0",
        "requirements": [],
        "requirementIds": [],
        "fallbackHint": "四舵机转向访客并挥手",
        "operatorCue": "当 Mira 需要打招呼或欢迎访客时执行。",
    },
    "thinking_ponder": {
        "emotionTags": ["思考", "发呆", "沉思"],
        "readiness": "ready",
        "durationMs": 5000,
        "accent": "dream",
        "priority": "P1",
        "requirements": [],
        "requirementIds": [],
        "fallbackHint": "四舵机缓慢环顾并歪头",
        "operatorCue": "当 Mira 被问到问题、需要思考时执行。",
    },
    "angry_pout": {
        "emotionTags": ["愤怒", "生气", "不满"],
        "readiness": "ready",
        "durationMs": 4000,
        "accent": "alert",
        "priority": "P1",
        "requirements": [],
        "requirementIds": [],
        "fallbackHint": "四舵机快速跺脚转身，红灯",
        "operatorCue": "当 Mira 被惹恼或表达不满时执行。",
    },
    "proud_chest": {
        "emotionTags": ["骄傲", "自豪", "自信"],
        "readiness": "ready",
        "durationMs": 4000,
        "accent": "celebrate",
        "priority": "P1",
        "requirements": [],
        "requirementIds": [],
        "fallbackHint": "四舵机挺胸抬头到最高",
        "operatorCue": "当 Mira 完成成就或表达自豪时执行。",
    },
    "sleepy_drowse": {
        "emotionTags": ["困倦", "打盹", "犯困"],
        "readiness": "ready",
        "durationMs": 5000,
        "accent": "sleep",
        "priority": "P1",
        "requirements": [],
        "requirementIds": [],
        "fallbackHint": "四舵机缓慢下垂再惊醒",
        "operatorCue": "当 Mira 犯困或需要夜间模式时执行。",
    },
    "laugh_giggle": {
        "emotionTags": ["大笑", "欢乐", "好笑"],
        "readiness": "ready",
        "durationMs": 4000,
        "accent": "celebrate",
        "priority": "P1",
        "requirements": [],
        "requirementIds": [],
        "fallbackHint": "四舵机节奏弹跳摇摆",
        "operatorCue": "当 Mira 听到笑话或需要表达欢乐时执行。",
    },
    "love_heart": {
        "emotionTags": ["爱心", "爱意", "温暖"],
        "readiness": "ready",
        "durationMs": 4500,
        "accent": "warm",
        "priority": "P1",
        "requirements": [],
        "requirementIds": [],
        "fallbackHint": "四舵机缓慢靠近并心跳脉动",
        "operatorCue": "当 Mira 需要表达爱意或温暖情感时执行。",
    },
    "confused_lost": {
        "emotionTags": ["困惑", "迷茫", "不明白"],
        "readiness": "ready",
        "durationMs": 4000,
        "accent": "curious",
        "priority": "P1",
        "requirements": [],
        "requirementIds": [],
        "fallbackHint": "四舵机左右张望并耸肩",
        "operatorCue": "当 Mira 听不懂或感到困惑时执行。",
    },
    "bow_thanks": {
        "emotionTags": ["鞠躬", "感谢", "致谢"],
        "readiness": "ready",
        "durationMs": 3500,
        "accent": "warm",
        "priority": "P0",
        "requirements": [],
        "requirementIds": [],
        "fallbackHint": "四舵机缓慢深鞠躬",
        "operatorCue": "当 Mira 需要表达感谢或行礼时执行。",
    },
    "excited_bounce": {
        "emotionTags": ["兴奋", "激动", "极度开心"],
        "readiness": "ready",
        "durationMs": 4000,
        "accent": "celebrate",
        "priority": "P0",
        "requirements": [],
        "requirementIds": [],
        "fallbackHint": "四舵机快速弹跳，彩虹灯效",
        "operatorCue": "当 Mira 遇到极其兴奋的事时执行。",
    },
}
...
SCENES: Dict[str, Dict[str, Any]] = {
    ...
    "look_left": {
        "title": "向左看",
        "host_line": "Mira 听到方向指令后，会先轻轻确认，再慢慢看向左边。",
        "notes": [
            "语音方向指令专用封装，只复用已有 curious / tilt 动作语言，不开放任意角度。",
        ],
        "tuning_notes": [
            "动作要像听懂后转头确认，不要做成快速机械转向。",
        ],
        "steps": [
            pose("neutral"),
    ...
    "look_right": {
        "title": "向右看",
        "host_line": "Mira 听到方向指令后，会先歪一下头，再慢慢看向右边。",
        "notes": [
            "语音方向指令专用封装，复用 cute_probe / daydream 中已存在的右歪头和回中节奏。",
        ],
        "tuning_notes": [
            "当前右向动作幅度保持克制，等待真实硬件验证后再扩大 yaw 幅度。",
        ],
        "steps": [
            pose("neutral"),
            led("solid", brightness=118, color=SOFT_WARM),
            ...
            pose("tilt_right"),
            delay(220),
            absolute(servo1=82, servo2=96, servo3=98, servo4=88),
            delay(360),
            pose("tilt_right"),
            delay(180),
            pose("neutral"),
    ...
    "voice_demo_tired": {
        ...
        "steps": [
            pose("neutral"),
            led("breathing", brightness=75, color=COMFORT_WARM),
            comment("Reuse touch_affection: lean closer first."),
            absolute(servo1=94, servo2=100, servo3=108, servo4=90),
            delay(260),
            audio(text="我在，先靠一下。", wait=False, voice="say"),
            absolute(servo1=94, servo2=104, servo3=110, servo4=94),
            delay(240),
            comment("Reuse touch_affection: a small visible nuzzle."),
            absolute(servo1=98, servo2=104, servo3=110, servo4=94),
            delay(140),
            absolute(servo1=90, servo2=104, servo3=110, servo4=86),
            delay(140),
            ...
            absolute(servo1=90, servo2=103, servo3=109, servo4=86),
            delay(180),
            comment("Reuse sleep: lower the head and settle with the user."),
            absolute(servo1=90, servo2=94, servo3=96, servo4=98),
            delay(280),
            pose("neutral"),
    ...
    # --- New emotional scenes (11-26): minimal definitions for LLM manifest ---
    # These scenes are executed via four_servo_control.py on the board,
    # but need entries here so the LLM planner includes them in sceneNames.
    "happy_dance": {
        "title": "开心跳舞",
        "host_line": "Mira 开心到跳起来，四个舵机一起弹跳摇摆。",
        "notes": ["四舵机全参与。"],
        "tuning_notes": ["速度从慢到快再到慢，体现情绪起伏。"],
        "steps": [
            pose("neutral"),
            led("solid", brightness=150, color={"r": 255, "g": 220, "b": 100}),
            delay(100),
            absolute(servo1=90, servo2=104, servo3=110, servo4=86),
            delay(200),
            absolute(servo1=90, servo2=88, servo3=86, servo4=94),
            delay(200),
            absolute(servo1=100, servo2=104, servo3=110, servo4=86),
            delay(150),
            absolute(servo1=80, servo2=88, servo3=86, servo4=94),
            delay(150),
            absolute(servo1=100, servo2=106, servo3=114, servo4=84),
            delay(120),
            absolute(servo1=80, servo2=86, servo3=84, servo4=96),
            delay(120),
            absolute(servo1=90, servo2=104, servo3=110, servo4=86),
            delay(100),
            absolute(servo1=90, servo2=88, servo3=86, servo4=94),
    ...
    "sad_comfort": {
        "title": "难过安慰",
        "host_line": "Mira 难过地低下头，缓慢摇摆，灯光变暗。",
        "notes": ["四舵机全参与。"],
        "tuning_notes": ["速度极慢，体现悲伤。"],
        "steps": [
            pose("neutral"),
            led("solid", brightness=60, color={"r": 100, "g": 120, "b": 180}),
            delay(200),
            absolute(servo1=90, servo2=88, servo3=84, servo4=100),
            delay(400),
            absolute(servo1=84, servo2=86, servo3=82, servo4=102),
            delay(400),
            absolute(servo1=96, servo2=88, servo3=84, servo4=100),
            delay(400),
            absolute(servo1=90, servo2=84, servo3=80, servo4=104),
            delay(500),
            absolute(servo1=90, servo2=88, servo3=84, servo4=100),
            delay(300),
            pose("neutral"),
    ...
    "curious_peek": {
        "title": "好奇探头",
        "host_line": "Mira 好奇地探头查看，快速伸出又缩回。",
        "notes": ["四舵机全参与。"],
        "tuning_notes": ["速度快慢交替，体现好奇与犹豫。"],
        "steps": [
            pose("neutral"),
            led("solid", brightness=130, color={"r": 200, "g": 255, "b": 200}),
            delay(100),
            absolute(servo1=96, servo2=100, servo3=104, servo4=90),
            delay(150),
            absolute(servo1=100, servo2=104, servo3=110, servo4=88),
            delay(100),
            absolute(servo1=96, servo2=98, servo3=100, servo4=92),
            delay(200),
            absolute(servo1=102, servo2=106, servo3=114, servo4=86),
            delay(100),
            absolute(servo1=94, servo2=96, servo3=98, servo4=94),
            delay(200),
            pose("neutral"),
            delay(150),
        ],
    ...
    "shy_blush": {
        "title": "害羞脸红",
        "host_line": "Mira 被夸奖后害羞地转开，再偷偷看回来。",
        "notes": ["四舵机全参与。"],
        "tuning_notes": ["速度慢，偷看时稍快。"],
        "steps": [
            pose("neutral"),
            led("solid", brightness=120, color={"r": 255, "g": 150, "b": 160}),
            delay(200),
            absolute(servo1=82, servo2=94, servo3=94, servo4=100),
            delay(400),
            absolute(servo1=78, servo2=92, servo3=92, servo4=102),
            delay(300),
            nudge(servo4=-4),
            delay(150),
            nudge(servo4=4),
            delay(150),
            absolute(servo1=88, servo2=96, servo3=100, servo4=94),
            delay(200),
            absolute(servo1=94, servo2=98, servo3=104, servo4=90),
            delay(150),
            pose("neutral"),
            delay(200),
        ],
    ...
    "stretch_yawn": {
        "title": "伸懒腰",
        "host_line": "Mira 大幅伸展四个舵机，打个大哈欠。",
        "notes": ["四舵机全参与。"],
        "tuning_notes": ["速度慢，伸展到极限。"],
        "steps": [
            pose("neutral"),
            led("solid", brightness=140, color={"r": 255, "g": 240, "b": 200}),
            delay(100),
            absolute(servo1=90, servo2=106, servo3=118, servo4=82),
            delay(500),
            absolute(servo1=96, servo2=108, servo3=120, servo4=80),
            delay(400),
            absolute(servo1=84, servo2=106, servo3=118, servo4=84),
            delay(400),
            absolute(servo1=90, servo2=100, servo3=108, servo4=88),
            delay(300),
            pose("neutral"),
            delay(200),
        ],
    ...
    "alert_startle": {
        "title": "受惊吓",
        "host_line": "Mira 被吓到后四个舵机猛然弹开，再缓慢恢复。",
        "notes": ["四舵机全参与。"],
        "tuning_notes": ["受惊极快，恢复极慢。"],
        "steps": [
            pose("neutral"),
            led("solid", brightness=200, color={"r": 255, "g": 50, "b": 50}),
            absolute(servo1=90, servo2=108, servo3=120, servo4=78),
            delay(80),
            absolute(servo1=76, servo2=110, servo3=120, servo4=80),
            delay(100),
            led("solid", brightness=100, color={"r": 255, "g": 200, "b": 180}),
            absolute(servo1=84, servo2=104, servo3=112, servo4=86),
            delay(300),
            absolute(servo1=92, servo2=100, servo3=104, servo4=90),
            delay(300),
            pose("neutral"),
            delay(200),
        ],
    ...
    "greeting_wave": {
        "title": "打招呼",
        "host_line": "Mira 转向访客挥手打招呼，四个舵机配合。",
        "notes": ["四舵机全参与。"],
        "tuning_notes": ["速度中快，开朗友好。"],
        "steps": [
            pose("neutral"),
            led("solid", brightness=150, color={"r": 255, "g": 230, "b": 180}),
            delay(100),
            absolute(servo1=100, servo2=100, servo3=106, servo4=88),
            delay(150),
            nudge(servo4=-6),
            delay(120),
            nudge(servo4=6),
    ...
    "thinking_ponder": {
        "title": "思考发呆",
        "host_line": "Mira 陷入沉思，四个舵机缓慢环顾，最后灵光一闪。",
        "notes": ["四舵机全参与。"],
        "tuning_notes": ["速度极慢，灵光一闪时快。"],
        "steps": [
            pose("neutral"),
            led("solid", brightness=100, color={"r": 180, "g": 200, "b": 255}),
            delay(200),
            absolute(servo1=98, servo2=96, servo3=98, servo4=94),
            delay(400),
            absolute(servo1=104, servo2=97, servo3=100, servo4=96),
            delay(400),
            absolute(servo1=82, servo2=96, servo3=96, servo4=96),
            delay(400),
            absolute(servo1=90, servo2=94, servo3=94, servo4=98),
            delay(300),
            led("solid", brightness=180, color={"r": 255, "g": 255, "b": 200}),
            absolute(servo1=90, servo2=102, servo3=108, servo4=86),
            delay(150),
            pose("neutral"),
            delay(200),
        ],
    ...
    "angry_pout": {
        "title": "愤怒生气",
        "host_line": "Mira 生气地跺脚转身，红灯闪烁，再缓慢消气。",
        "notes": ["四舵机全参与。"],
        "tuning_notes": ["愤怒极快，消气极慢。"],
        "steps": [
            pose("neutral"),
            led("solid", brightness=180, color={"r": 255, "g": 50, "b": 50}),
            delay(80),
            absolute(servo1=78, servo2=92, servo3=88, servo4=104),
            delay(100),
            led("solid", brightness=80, color={"r": 200, "g": 50, "b": 50}),
            delay(80),
            led("solid", brightness=180, color={"r": 255, "g": 50, "b": 50}),
            absolute(servo1=76, servo2=90, servo3=86, servo4=106),
            delay(100),
            led("solid", brightness=100, color={"r": 255, "g": 150, "b": 120}),
            absolute(servo1=84, servo2=94, servo3=92, servo4=100),
            delay(300),
            absolute(servo1=90, servo2=96, servo3=96, servo4=96),
            delay(300),
            pose("neutral"),
            delay(200),
        ],
    ...
    "proud_chest": {
        "title": "骄傲自信",
        "host_line": "Mira 挺胸抬头到最高，自豪地环顾四周。",
        "notes": ["四舵机全参与。"],
        "tuning_notes": ["速度慢而庄重。"],
        "steps": [
            pose("neutral"),
            led("solid", brightness=160, color={"r": 255, "g": 215, "b": 100}),
            delay(100),
            absolute(servo1=90, servo2=106, servo3=116, servo4=82),
            delay(400),
            absolute(servo1=100, servo2=106, servo3=116, servo4=84),
            delay(300),
            absolute(servo1=80, servo2=106, servo3=116, servo4=84),
            delay(300),
            absolute(servo1=90, servo2=106, servo3=116, servo4=82),
            delay(300),
            pose("neutral"),
    ...
    "sleepy_drowse": {
        "title": "困倦打盹",
        "host_line": "Mira 犯困了，头慢慢下垂，挣扎着醒来又打盹。",
        "notes": ["四舵机全参与。"],
        "tuning_notes": ["速度极慢，惊醒时快。"],
        "steps": [
            pose("neutral"),
            led("solid", brightness=50, color={"r": 100, "g": 100, "b": 150}),
            delay(200),
            absolute(servo1=90, servo2=90, servo3=86, servo4=98),
            delay(500),
            absolute(servo1=90, servo2=84, servo3=80, servo4=104),
            delay(500),
            led("solid", brightness=120, color={"r": 255, "g": 230, "b": 180}),
            absolute(servo1=90, servo2=100, servo3=104, servo4=88),
            delay(200),
            led("solid", brightness=50, color={"r": 100, "g": 100, "b": 150}),
            absolute(servo1=90, servo2=86, servo3=82, servo4=102),
            delay(400),
            pose("neutral"),
            delay(200),
        ],
    ...
    "laugh_giggle": {
        "title": "大笑欢乐",
        "host_line": "Mira 笑得前仰后合，四个舵机节奏弹跳。",
        "notes": ["四舵机全参与。"],
        "tuning_notes": ["速度中快，有节奏感。"],
        "steps": [
            pose("neutral"),
            led("solid", brightness=180, color={"r": 255, "g": 255, "b": 150}),
            delay(100),
            absolute(servo1=90, servo2=104, servo3=112, servo4=84),
            delay(120),
            absolute(servo1=90, servo2=90, servo3=86, servo4=96),
            delay(120),
            absolute(servo1=96, servo2=106, servo3=114, servo4=82),
            delay(100),
            absolute(servo1=84, servo2=90, servo3=86, servo4=96),
            delay(100),
            absolute(servo1=90, servo2=104, servo3=112, servo4=84),
            delay(80),
            absolute(servo1=90, servo2=92, servo3=90, servo4=94),
            delay(80),
            absolute(servo1=90, servo2=102, servo3=108, servo4=88),
            delay(100),
            pose("neutral"),
            delay(200),
        ],
    ...
    "love_heart": {
        "title": "爱心表白",
        "host_line": "Mira 缓慢靠近，灯光变暖粉，做心跳脉动。",
        "notes": ["四舵机全参与。"],
        "tuning_notes": ["速度极慢而温柔。"],
        "steps": [
            pose("neutral"),
            led("solid", brightness=120, color={"r": 255, "g": 150, "b": 180}),
            delay(200),
            absolute(servo1=94, servo2=100, servo3=104, servo4=90),
            delay(300),
            absolute(servo1=96, servo2=102, servo3=106, servo4=88),
            delay(300),
            comment("心跳脉动"),
            led("solid", brightness=160, color={"r": 255, "g": 100, "b": 150}),
            nudge(servo2=2, servo3=2),
            delay(150),
            led("solid", brightness=100, color={"r": 255, "g": 150, "b": 180}),
            nudge(servo2=-2, servo3=-2),
            delay(200),
            led("solid", brightness=160, color={"r": 255, "g": 100, "b": 150}),
            nudge(servo2=2, servo3=2),
    ...
    "confused_lost": {
        "title": "困惑迷茫",
        "host_line": "Mira 听不懂，左右张望，歪头耸肩。",
        "notes": ["四舵机全参与。"],
        "tuning_notes": ["速度中等，犹豫不决。"],
        "steps": [
            pose("neutral"),
            led("solid", brightness=100, color={"r": 200, "g": 200, "b": 255}),
            delay(150),
            absolute(servo1=102, servo2=96, servo3=98, servo4=94),
            delay(250),
            absolute(servo1=78, servo2=96, servo3=98, servo4=96),
            delay(250),
            absolute(servo1=90, servo2=94, servo3=94, servo4=100),
            delay(200),
            nudge(servo4=-6),
            delay(150),
            nudge(servo4=6),
    ...
    "bow_thanks": {
        "title": "鞠躬致谢",
        "host_line": "Mira 缓慢深鞠躬，表达感谢，再优雅起身。",
        "notes": ["四舵机全参与。"],
        "tuning_notes": ["速度慢而庄重。"],
        "steps": [
            pose("neutral"),
            led("solid", brightness=140, color={"r": 255, "g": 230, "b": 180}),
            delay(100),
            absolute(servo1=90, servo2=88, servo3=82, servo4=96),
            delay(400),
            absolute(servo1=90, servo2=82, servo3=76, servo4=100),
            delay(500),
            absolute(servo1=90, servo2=88, servo3=82, servo4=96),
            delay(300),
            absolute(servo1=90, servo2=100, servo3=106, servo4=88),
            delay(300),
            pose("neutral"),
            delay(200),
        ],
    ...
    "excited_bounce": {
        "title": "兴奋激动",
        "host_line": "Mira 超级兴奋，四个舵机快速弹跳，灯光彩虹旋转。",
        "notes": ["四舵机全参与。"],
        "tuning_notes": ["速度从快到最快再到慢。"],
        "steps": [
            pose("neutral"),
            led("solid", brightness=200, color={"r": 255, "g": 100, "b": 100}),
            delay(80),
            absolute(servo1=90, servo2=106, servo3=116, servo4=80),
            delay(80),
            led("solid", brightness=200, color={"r": 100, "g": 255, "b": 100}),
            absolute(servo1=90, servo2=86, servo3=84, servo4=100),
            delay(80),
            led("solid", brightness=200, color={"r": 100, "g": 100, "b": 255}),
            absolute(servo1=100, servo2=108, servo3=118, servo4=78),
            delay(60),
            led("solid", brightness=200, color={"r": 255, "g": 255, "b": 100}),
            absolute(servo1=80, servo2=86, servo3=84, servo4=100),
            delay(60),
            led("solid", brightness=200, color={"r": 255, "g": 100, "b": 255}),
            absolute(servo1=90, servo2=106, servo3=116, servo4=80),
            delay(60),
            absolute(servo1=90, servo2=96, servo3=98, servo4=90),
            delay(100),
