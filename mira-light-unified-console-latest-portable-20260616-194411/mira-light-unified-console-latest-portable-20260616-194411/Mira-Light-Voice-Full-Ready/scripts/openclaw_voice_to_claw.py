...
def resolve_input_device(device_hint: str | None) -> dict[str, Any]:
    ...
    if device_hint and device_hint.strip().lower() != "default":
...
def transcribe_local(
    ...
    *,
    ...
    if mlx_whisper is None:
        raise VoiceToClawError("Local transcription is not supported on this platform (mlx_whisper is not installed).")
