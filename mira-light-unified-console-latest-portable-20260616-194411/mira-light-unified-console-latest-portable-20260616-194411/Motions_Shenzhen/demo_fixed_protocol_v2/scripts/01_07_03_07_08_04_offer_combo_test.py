...
offer_celebrate = load_script_module("_offer_celebrate_scene_04", "04_offer_celebrate_demo.py")
...
def build_steps(
    *,
    ...
    steps.append(pause_between("intermission 08 photo pose to 04 offer celebration", gap_after_photo))
...
def main() -> None:
    parser = build_parser(
        "Combo test: 01+07 wake/tabletop, 03 right-hand nuzzle, 07 tabletop follow, 08 photo pose, then 04 offer celebration."
    )
    ...
    parser.add_argument("--gap-after-photo", type=float, default=5.0)
    ...
    exit_from_plan(
        ...
        steps=build_steps(
            ...
            gap_after_photo=args.gap_after_photo,
