...
- [`../scripts/mira_light_signal_delivery.py`](../scripts/mira_light_signal_delivery.py)
...
- 运行时状态来自外部 Mira Light bridge 的 `/v1/mira-light/runtime`
...
- 外部 Mira Light bridge 的 `/v1/mira-light/scenes`
- 本迁移包中的 [`../scripts/scenes.py`](../scripts/scenes.py) 保留了 `SCENE_META` 作为 scene 元信息参考
