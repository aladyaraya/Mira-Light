...
function renderRuntime(runtime) {
  ...
  const currentBaseUrl = runtime.baseUrl || baseUrlInput.value || FIXED_LAMP_BASE_URL;
  runtimeBaseUrl.textContent = currentBaseUrl;
...
async function saveConfig() {
  try {
    const data = await fetchJson("/api/config", {
      method: "POST",
      body: JSON.stringify({
        baseUrl: baseUrlInput.value || FIXED_LAMP_BASE_URL,
